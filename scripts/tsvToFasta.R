#### Setup section ####
#Setup variables
pathToOrig <- "./data/data_ignored/TS_all_filtered.recode_wide1.tsv"
...
#Use the recoded genotypes to create alignable sequence
...
write(sequences,file = paste0("./data/",gsub("\\.tsv$","",basename(pathToOrig)),".fasta"))
